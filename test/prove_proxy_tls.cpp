...
bool prove_proxy_tls(int party) {
    ...
    unsigned char server_fin_msg[] = {0x14, 0x00, 0x00, 0x0c, 0xc3, 0x3d, 0x4b, 0xf9, 0x89, 0x0e, 0x00, 0xd9, 0x7d, 0x06, 0x87, 0xb5};
    ...
    // prove prf
    Integer ms, key_c, key_s, iv_c, iv_s, fin_c, fin_s;
    {
        PRFProver prover;
...
int main(int argc, char** argv) {
    ...
    FunctionWrapperV2::setExceptionMsgPtr(&exception_msg);
